...
function computeGraphLayout(commits) {
  const activeLanes = [];
  const laneColor = /* @__PURE__ */ new Map();
  let nextColor = 0;
  const findLane = (sha) => activeLanes.indexOf(sha);
  const allocateLane = () => {
...
const useLogStore = create((set) => ({
  ...
  load: async (repoPath) => {
    set({ isLoading: true, error: null });
    const result = await window.gitApi.getLog(repoPath, { maxCount: 1e3 });
    if (!result.ok) {
      set({ isLoading: false, error: result.error.message });
      return;
    }
...
function currentBranchName(branches) {
...
function Button({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `${base} ${variants[variant]} ${className}`, ...rest });
}
function WelcomeScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col items-center justify-center gap-4", children: [
    ...
    recentRepos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-96", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 text-[11px] uppercase text-ide-textDim", children: "Recent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded border border-ide-border", children: recentRepos.map((path) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
async function invalidate(repoPath, parts) {
  const tasks = [];
...
function StatusBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-6 shrink-0 items-center gap-3 border-t border-ide-border bg-ide-panel px-3 text-[11px] text-ide-textDim", children: [
    ...
    status && (status.ahead > 0 || status.behind > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      ...
      status.behind > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-ide-red", children: [
        "↓",
        status.behind
      ] })
    ] })
  ...
  for (const branch of branches) {
    ...
    parts.forEach((part, i) => {
      ...
      if (!node.children.has(part)) {
        node.children.set(part, { name: part, fullPath: pathSoFar, children: /* @__PURE__ */ new Map() });
      }
...
function ContextMenu({ x, y, items, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: { left: x, top: y },
      children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: `block w-full px-3 py-1.5 text-left text-[13px] hover:bg-ide-selected disabled:opacity-40 disabled:hover:bg-transparent ${item.danger ? "text-ide-red" : "text-ide-text"}`,
        ...
        item.separatorAfter && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-1 border-t border-ide-border" })
      ] }, i))
    }
  );
}
function BranchContextMenu({
  ...
  y,
  branch,
  currentBranchName: currentBranchName2,
  onClose
}) {
  const repoPath = useRepoStore((s) => s.repoPath);
  ...
  if (branch.kind === "local" && !branch.isHead && currentBranchName2) {
    items.push({
      label: `Merge into ${currentBranchName2}`,
...
function BranchSwitcherPopup() {
  ...
  const filtered = reactExports.useMemo(
    () => branches.filter((b) => b.kind !== "tag").filter((b) => b.name.toLowerCase().includes(query.toLowerCase())),
    [branches, query]
  );
  if (!open) return null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-start justify-center bg-black/30 pt-24", onClick: () => setOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-h-96 overflow-auto py-1", children: [
          filtered.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: b.isHead ? "font-semibold text-ide-accent" : "text-ide-text", children: b.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-ide-textDim", children: b.kind })
              ]
            },
            b.refName
          )),
          filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-center text-ide-textDim", children: "No branches found" })
        ] })
      ]
    }
  ) });
...
const useDiffStore = create((set) => ({
  target: null,
  files: [],
  isLoading: false,
  error: null,
  selectCommit: async (repoPath, sha) => {
  ...
  selectWorkingFile: async (repoPath, path, staged) => {
...
function CommitGraphColumn({ row, prevRow }) {
  const width = Math.max(row.laneCount * LANE_WIDTH + LANE_WIDTH, LANE_WIDTH * 2);
  const cx = (lane) => lane * LANE_WIDTH + LANE_WIDTH / 2;
  const midY = ROW_HEIGHT / 2;
  const color = (lane) => LANE_COLORS[lane % LANE_COLORS.length];
  const passThroughLanes = /* @__PURE__ */ new Set();
  if (prevRow) {
    for (const e of prevRow.edges) {
      if (e.toLane !== row.lane && e.toLane === e.fromLane) passThroughLanes.add(e.toLane);
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width, height: ROW_HEIGHT, className: "shrink-0 overflow-visible", children: [
    ...
    prevRow?.edges.some((e) => e.toLane === row.lane) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "line",
      {
        x1: cx(row.lane),
        y1: 0,
    ...
    row.edges.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: cx(row.lane), cy: midY, r: 4.5, fill: color(row.lane), stroke: "#1e1f22", strokeWidth: 1.5 })
  ] });
}
const STYLES = {
...
function RefBadge({ ref }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `mr-1 rounded px-1.5 py-0.5 text-[11px] font-medium ${STYLES[ref.type]}`, children: ref.name });
}
...
function CommitRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `flex cursor-pointer items-center border-b border-ide-border/40 px-2 text-[13px] ${isSelected ? "bg-ide-selected" : "hover:bg-ide-hover"}`,
      style: { height: ROW_HEIGHT },
      onClick,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CommitGraphColumn, { row, prevRow, nextRow }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 items-center gap-1 px-2", children: [
          commit.refs.map((ref, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(RefBadge, { ref }, i)),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `truncate ${isWorkingTreeRow ? "italic text-ide-textDim" : ""}`, children: commit.subject })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-36 shrink-0 truncate px-2 text-ide-textDim", children: commit.authorName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 shrink-0 px-2 text-ide-textDim", children: formatRelativeDate(commit.date) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 shrink-0 px-2 font-mono text-ide-textDim", children: shortSha(commit.sha) })
      ]
    }
  );
}
function CommitLogTable() {
  ...
  const [selectedSha, setSelectedSha] = reactExports.useState(null);
  ...
  if (isLoading && graphRows.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-textDim", children: "Loading commit history…" });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-red", children: error });
  }
  if (graphRows.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-textDim", children: "No commits yet." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: parentRef, className: "h-full overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: virtualizer.getTotalSize(), position: "relative" }, children: virtualizer.getVirtualItems().map((vi) => {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          CommitRow,
          {
            ...
            isSelected: selectedSha === row.commit.sha || target?.type === "commit" && target.sha === row.commit.sha,
            onClick: () => {
...
function FileRow({ file, isSelected, actionLabel, onSelect, onAction }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `group flex cursor-pointer items-center gap-2 px-2 py-1 text-[13px] ${isSelected ? "bg-ide-selected" : "hover:bg-ide-hover"}`,
      onClick: onSelect,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-4 shrink-0 font-mono font-bold ${STATUS_COLOR[file.status]}`, children: STATUS_LABEL[file.status] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "min-w-0 flex-1 truncate", children: file.path }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
function CommitMessageBox() {
  ...
  const doCommit = async (amend = false) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-ide-border p-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-ide-textDim", children: [
        stagedCount,
        " file(s) staged"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy, onClick: () => doCommit(true), children: "Amend" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "primary",
...
function ChangesPanel() {
  ...
  if (!status) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-textDim", children: "Loading changes…" });
  const handleSelect = (path, staged) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CommitMessageBox, {})
  ] });
}
const LINE_STYLE = {
...
function InlineDiffView({ file }) {
  if (file.isBinary) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-textDim", children: "Binary file changed" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto font-mono text-[12px] leading-5", children: file.hunks.map((hunk, hi) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `px-2 ${LINE_STYLE["hunk-header"]}`, children: hunk.header }),
    hunk.lines.map((line, li) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex px-2 whitespace-pre ${LINE_STYLE[line.type]}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-3 inline-block w-8 shrink-0 select-none text-right text-ide-textDim", children: line.oldLineNo ?? "" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-3 inline-block w-8 shrink-0 select-none text-right text-ide-textDim", children: line.newLineNo ?? "" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "select-none", children: line.type === "add" ? "+" : line.type === "del" ? "-" : " " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: line.text })
    ] }, li))
  ] }, hi)) });
}
function DiffViewer() {
  ...
  if (!target) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center text-ide-textDim", children: "Select a commit or a changed file to view its diff" });
  }
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-textDim", children: "Loading diff…" });
  if (error) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-red", children: error });
  if (files.length === 0) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-ide-textDim", children: "No changes" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full", children: [
    files.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-56 shrink-0 overflow-auto border-r border-ide-border py-1", children: files.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `cursor-pointer truncate px-2 py-1 text-[12px] ${current.path === f.path ? "bg-ide-selected" : "hover:bg-ide-hover"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 border-b border-ide-border bg-ide-panelAlt px-2 py-1 text-[12px] text-ide-textDim", children: current.path }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InlineDiffView, { file: current })
    ] })
  ] });
}
